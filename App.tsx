...
import { EvaluationsList, SelectPatientForEvaluation, EvaluationWizard, EvaluationDetails, CompareEvaluations } from './pages/Evaluations';
import { ExportEvaluation, EvaluationSuccess, ImageAnnotation } from './pages/EvaluationTools';
